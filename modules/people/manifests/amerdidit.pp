class people::amerdidit {

  $home     = "/Users/amer"

  # include projects::likealyzer
  # include projects::meltwater_developer_blog
  # include projects::mobbuzz
  # include projects::skimpyurl
  # include projects::entitlement
